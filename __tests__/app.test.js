...
describe('Order Router CRUD Routes', () => {
  ...
  it('Returns all orders from a single customer by ID', async () => {
    ...
    expect(res.body).toEqual([
      {"order_id":1,"coffee_type":"Ethopian","quantity":5,"order_date":"2021-03-25T07:00:00.000Z","subscription":2,"linked_customer_id":1},
      {"order_id":2,"coffee_type":"Honduras","quantity":10,"order_date":"2021-03-25T07:00:00.000Z","subscription":3,"linked_customer_id":1}
    ])
